...
func (r backoffRetryStrategy) GetParams() map[string]interface{} {
	return map[string]interface{}{
		"min_wait": strconv.Itoa(int(r.min.Seconds() * 1000)),
		"max_wait": strconv.Itoa(int(r.max.Seconds() * 1000)),
	}
}

func (r backoffRetryStrategy) Clone(verbs ...string) RetryStrategy {
	return NewExponentialBackoffRetryStrategyWithCustomFactorAndMultiplier(r.min, r.max, r.factor, r.multiplier, verbs...)
}